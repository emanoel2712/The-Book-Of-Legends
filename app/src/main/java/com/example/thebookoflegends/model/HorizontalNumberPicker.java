...
public class HorizontalNumberPicker extends LinearLayout {
    ...
    public HorizontalNumberPicker(Context context, @Nullable AttributeSet attrs) {
        ...
        et_number.setTextColor(context.getResources().getColor(R.color.colorWhite));
        et_number.setEnabled(false);
        et_number.setFocusable(false);

        final Button btn_less = findViewById(R.id.btn_less);
        btn_less.setBackground(getResources().getDrawable(R.drawable.loja_bt_menos));
        btn_less.setOnClickListener(new AddHandler(-1));

        final Button btn_more = findViewById(R.id.btn_more);
        btn_more.setBackground(getResources().getDrawable(R.drawable.loja_bt_mais));
